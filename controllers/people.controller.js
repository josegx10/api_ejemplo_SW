...
export const getPeoples = async (req, res) => {
  ...
  if (req.query.search) {
    ...
    let peoples = {
      ...
      next:
        perPage * page < cont
          ? `http://192.168.1.162:4000/api/people/?search=${
              req.query.search
            }&page=${+page + 1}`
          : null,
      previous:
    ...
    let peoples = {
      ...
      next:
        perPage * page < cont
          ? `http://192.168.1.162:4000/api/people/?page=${+page + 1}`
          : null,
      previous:
        page > 1 ? `http://192.168.1.162:4000/api/people/?page=${page - 1}` : null,
